 ...
 *
 * Sélecteur dynamique souverain — « Ñkyel Auto » par défaut.
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      <button
        ...
        aria-haspopup="true"
      >
        <Sparkle size={14} className="text-[#C39A52]" weight="fill" />
          ...
          <>
            ...
            >
                ...
                {DYNAMIC_ENGINES.map((engine) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <Check size={16} className="text-[#6F9485] shrink-0 mt-0.5" weight="bold" />
                      )}
                    </button>
                  );
                })}
              ...
              <div className="mt-1 px-3 py-1.5 border-t border-white/[0.04] flex items-center justify-between text-[10px] text-[#7E8795] font-mono">
                ...
                <span className="text-[#6F9485]">Connecté</span>
              </div>
            </motion.div>
          </>
        )}
