/**
 * Nkyel AI · Custom Icons · TSX
 * SmartANDJ AI Technologies
 * Icônes originales — NouvellePiste, Aurata, Nkyel, OnyxGris, NkyelAgent, Wandana, Rendu, Projet
 */
...
/* 🕸️ NKYEL AGENT — Panthère multi-agent */
export const NkyelAgentIcon = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
