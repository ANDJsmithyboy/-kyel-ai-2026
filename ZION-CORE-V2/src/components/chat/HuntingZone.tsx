      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 h-full">
        ...
        >
          ...
          <div className="relative w-28 h-28 bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-[32px] flex items-center justify-center shadow-2xl p-4">
            <img src="/gaboma-logo-transparent.svg" alt="Gaboma AI Logo" className="w-full h-full object-contain drop-shadow-lg" />
          </div>
        </motion.div>
        ...
        >
          Demandez n'importe quoi à Gaboma AI.
        </motion.p>
      </div>
    );
  }
          ...
          {msg.role === 'assistant' && (
            <div className="w-full max-w-full md:max-w-[85%]">
              ...
              <div className="flex items-center justify-between mt-4 border-t border-white/5 pt-3">
                ...
                {/* Gaboma Seal for end of turn */}
                <div className="flex items-center gap-2 opacity-30 select-none">
                  <span className="text-[10px] uppercase font-bold tracking-widest">{msg.model || 'GABOMA AI'}</span>
