...
const eventMap: Record<string, NkyelVisualEventType> = {
  ...
  source: 'source.found',
  'source.discovered': 'source.found',
  'source.added': 'source.found',
  'evidence.created': 'source.found',
  'evidence.linked': 'source.found',
  rendu: 'artifact.created',
  'artifact.created': 'artifact.created',
  'media.image.completed': 'artifact.created',
  'media.video.completed': 'artifact.created',
  'google.sheets.created': 'artifact.created',
  'google.docs.created': 'artifact.created',
  'tool.started': 'tool.started',
  'tool.completed': 'tool.completed',
  'google.search.started': 'tool.started',
  'google.search.completed': 'tool.completed',
  'google.maps.started': 'tool.started',
  'google.maps.completed': 'tool.completed',
  'task.started': 'task.started',
  'media.image.requested': 'task.started',
  'media.video.requested': 'task.started',
  'plan.created': 'plan.created',
  'plan.updated': 'plan.created',
  done: 'mission.completed',
  completed: 'mission.completed',
  'final.delivered': 'mission.completed',
