...
const INITIAL_A2A_AGENTS: A2AAgentCard[] = [
  {
    id: 'agent_strategist',
    name: 'Ñkyel Stratège (Orchestrateur Principal)',
    role: 'Planification, Décomposition & Arbitrage',
    avatar: '👑',
    provider: 'Nkyel Core',
    endpoint: 'a2a://internal/orchestrator-v1',
    version: '3.0.0',
    status: 'idle',
    declaredCapabilities: ['planning', 'decomposition', 'workgraph_governance', 'synthesis'],
    supportedProtocols: ['A2A/2.0', 'MCP/1.0', 'AG-UI/1.2'],
    maxConcurrency: 10,
    activeDelegations: 1,
  ...
  },
  {
    ...
    name: 'Agent Analyste Financier',
    role: 'Modélisation quantitative, valorisation & audit',
    avatar: '📊',
    provider: 'Nkyel Core',
    endpoint: 'a2a://internal/analyst-financial-v2',
    version: '2.1.0',
    status: 'idle',
    declaredCapabilities: ['dcf_valuation', 'financial_audit', 'market_ratios', 'a2ui_generation'],
    supportedProtocols: ['A2A/2.0', 'A2UI/1.0'],
    maxConcurrency: 4,
    activeDelegations: 0,
  ...
  },
  {
    ...
    name: 'Agent Ingénieur Logiciel (fx Sandbox)',
    role: 'Implémentation, exécution sandbox & tests',
    avatar: '⚡',
    provider: 'Google Vertex',
    endpoint: 'a2a://vertex.google.com/nkyel-coder',
    version: '2.4.0',
    status: 'idle',
    declaredCapabilities: ['code_generation', 'sandbox_execution', 'linting', 'diff_production'],
    supportedProtocols: ['A2A/2.0', 'MCP/1.0'],
    maxConcurrency: 6,
    activeDelegations: 0,
  ...
  },
  {
    ...
    name: 'Agent Veille & Deep Research (Wandana)',
    role: 'Investigation multi-sources, vérification & citations',
    avatar: '🔍',
    provider: 'External A2A',
    endpoint: 'https://wandana.smartandj.ai/a2a/v1',
    version: '3.1.2',
    status: 'idle',
    declaredCapabilities: ['web_crawling', 'grounding_search', 'fact_checking', 'source_validation'],
    supportedProtocols: ['A2A/2.0', 'AG-UI/1.2'],
    maxConcurrency: 8,
    activeDelegations: 0,
