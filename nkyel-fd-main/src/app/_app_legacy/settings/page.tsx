/* Nkyel AI · settings/page.tsx · SmartANDJ AI Technologies · Constitution Zion Core
   Fondateur : Daniel Jonathan ANDJ
   Page paramètres complète — Apparence, Nkyel AI, Chat, Audio, À propos */
'use client';
...
const TABS: { key: TabKey; label: string; icon: typeof Palette }[] = [
  ...
  { key: 'Nkyel AI', label: 'Nkyel AI', icon: Sparkles },
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,0.8)' }}>
            ...
            >
              ...
              <p className="text-[13px] leading-relaxed" style={{ color: '#8A8A92' }}>
                Cette action est <strong style={{ color: '#ef4444' }}>irréversible</strong>. Votre Profil Cadre, vos conversations En Piste, et votre historique seront définitivement effacés de Nkyel AI.
              </p>
            ...
            {activeTab === 'apparence' && (
              <>
                ...
                <section>
                  ...
                  <p className="text-xs text-[var(--text-tertiary)] mb-3">Les 5 pétales du logo Nkyel AI</p>
                  <div className="space-y-1.5">
                    {ACCENTS.map((a) => (
                      <button
                        key={a.key}
            ...
            {activeTab === 'about' && (
              <section className="space-y-4">
                <div className="flex items-center gap-4">
                  <img src="/Nkyel AI-logo.jpeg" alt="Nkyel AI" className="w-16 h-16 rounded-2xl object-cover" />
                  <div>
                    <h2 className="text-lg font-bold text-[var(--text-primary)]">Nkyel AI</h2>
