/* Nkyel AI · Distillation Lab · SmartANDJ AI Technologies
...
export default function DistillationPage() {
  return (
    <div className="space-y-8">
      <SectionHeader title="Distillation Lab" subtitle="Pipeline Teacher→Student pour l'agent souverain Nkyel" />
