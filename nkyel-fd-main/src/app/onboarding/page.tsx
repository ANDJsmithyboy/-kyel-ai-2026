/* Nkyel AI · Onboarding Page · SmartANDJ AI Technologies
...
const STEPS: { key: StepKey; title: string; subtitle: string }[] = [
  ...
  { key: 'telemetry', title: 'Améliorer Nkyel AI',        subtitle: 'Aidez-nous à construire la meilleure IA gabonaise' },
];
    ...
    <div className="onboarding-root">
      ...
      <div className="onboarding-container">
        ...
        <header className="onboarding-header">
          ...
          <h1 className="onboarding-title">Bienvenue sur Nkyel AI</h1>
        ...
        <div className="onboarding-step-content" key={fadeKey}>
          ...
          {currentStep.key === 'consent' && (
            <div className="onboarding-card">
              <p className="onboarding-card-text">
                En utilisant Nkyel AI, vous acceptez nos conditions et notre politique de confidentialité.
              </p>
          ...
          {currentStep.key === 'telemetry' && (
            <div className="onboarding-card">
              <p className="onboarding-card-text">
                Vos données d&apos;utilisation, anonymisées, peuvent contribuer à améliorer les futurs modèles Nkyel AI. 
        ...
        {/* Footer */}
        <p className="onboarding-footer">SMARTANDJ AI TECHNOLOGIES · Nkyel AI 2026</p>
      </div>
