...
export default function ActionLauncher({
  ...
  const renderSubmenu = () => {
    ...
    return (
      <div className="nkyel-action-launcher-submenu absolute start-[calc(100%+12px)] z-50 h-[430px] w-[336px] flex-col overflow-hidden rounded-[14px] border border-white/[0.12] bg-[#242424] shadow-[0_18px_48px_rgba(0,0,0,0.48)]">
  ...
  return (
    <>
      ...
      <div className="nkyel-action-launcher-anchor absolute bottom-[calc(100%+10px)] start-0 z-50" onClick={(event) => event.stopPropagation()}>
